...
if (!function_exists('of_options'))
{
	function of_options()
	{
		...
		$of_options[] = array( "name" => "Event Display Date",
							"desc" => "Date format should be like this (25 JUN 2017) ",
							"id" => "info_event_date",
							"std" => "25 JUN 2017",
							"type" => "text"); //Done Change
		
		$of_options[] = array( "name" => "Event Count Down Date",
							"desc" => "Date format should be like this (25 JUN 2017) ",
							"id" => "info_event_countdown_date",
							"std" => "25 JUN 2017",
							"type" => "text"); //Done Change
		...
		$of_options[] = array( "name" => "Ticket Button Title",
							"desc" => "Event button text",
							"id" => "info_event_ticket_button",
							"std" => "Buy Ticket",
							"type" => "text"); //Done Change
		...
		$of_options[] = array( "name" => "Welcome Note",
							"desc" => "Type header welcome note",
							"id" => "welcome_note",
							"std" => "Welcome To Evont",
							"type" => "text"); //Done Change
		...
		$of_options[] = array( "name" => "Footer Background Image",
							"desc" => "Upload footer background image or paste image path.",
							"id" => "footer_bg_image",
							"std" => "",
							"mod" => "",
							"type" => "media");	
		...
		$of_options[] = array( "name" => "Typography",
							...
							//Arabic Font 
							$of_options[] = array( "name" => "Arabic Heading Font",
								"desc" => "Select font family to be used in arabic site",
								"id" => "google_font_ar_heading",
								"std" => "Cairo",
								"type" => "select_google_font",
								"preview" 	=> array(
												"text" => "This is my preview text!", //this is the text from preview box
								...
								"options" => $list_of_google_fonts_ar);
								
							$of_options[] = array( "name" => "Arabic Body Font",
								"desc" => "Select font family to be used in arabic site",
								"id" => "google_font_ar_body",
								"std" => "Cairo",
								"type" => "select_google_font",
								"preview" 	=> array(
												"text" => "This is my preview text!", //this is the text from preview box
		...
		$of_options[] = array( "name" => "Flickr",
								...
								"std" => "evont",
								"type" => "text"); //Done Change	
		$of_options[] = array( "name" => "Linedkin",
								"desc" => "Ex: evont",
								"id" => "text_linkedin",
								"std" => "evont",
								"type" => "text"); //Done Change
